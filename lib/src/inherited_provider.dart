  ...
  InheritedProvider({
    ...
    Widget? child,
        ...
        _delegate = _CreateInheritedProvider(
          create: create,
          update: update,
          updateShouldNotify: updateShouldNotify as bool Function(T?, T?)?,
          debugCheckInvalidValueType:
              debugCheckInvalidValueType as void Function(T?)?,
          startListening: startListening as void Function() Function(
              InheritedContext<T?>, T?)?,
          dispose: dispose,
        ),
